    ...
    <div class="page-breadcrumb">
        <nav class="c_breadcrumbs">
            <ul>
                ...
                <li class="active"><a href="<?php echo base_url('empresas/empresas') ?>">Control de Empresas</a></li>
            </ul>
        </nav>
    </div>
        ...
        <div class="c_panel">
            ...
            <div class="c_content">
                ...
                <div class="margin-bottom-20">
                    <div class="btn-group">
                      <a href="<?php echo base_url('empresas/nuevaEmpresa') ?>"><button class="btn btn-sm btn-success btn-raised rippler rippler-inverse"><i class="fa fa-plus"></i> Nueva Empresa</button></a>
                    </div>
                 </div>
