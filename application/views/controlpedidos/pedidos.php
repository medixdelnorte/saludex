    ...
    <div class="col-md-12">
        ...
        <div class="c_panel">
            ...
            <div class="c_content">
                ...
                <table id="tablaBoot" class="table table-bordered table-striped table-condensed table-hover cf" style="border-spacing:0px; width:100%">
                    <thead>
                        <tr>
                            <th>Op#</th>
                            <th>Empresa</th>
                     ...
                     ?>
                        <tr class="text-center">
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url("controlpedidos/verVenta/".$venta->op) ?>"><button type="button" class="btn btn-default btn-flat btn-xs" data-toggle="tooltip" title="Editar Venta"><i class="fa fa-pencil-square-o"></i></button></a>
                            </td>
                        </tr>
                    <?php 
                            endforeach;
